package org.riograndefoundation.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.riograndefoundation.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.riograndefoundation.repository.UserRepository.USERS_BY_EMAIL_CACHE);
